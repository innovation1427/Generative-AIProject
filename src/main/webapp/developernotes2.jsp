...
<section id="cat2">
	<div class="header">
		<div class="title">개발자 노트</div>
		<div class="back"><a href="devel.do?page=${currentPage}">목록</a></div>
	</div>
    <div class="center">
    	<div class="info">
    		<div class="title2">${devel.title}</div>
    		<div class="nick">${devel.nickname}</div>
    		<div class="date">${devel.postdate}</div>
    		<div class="count">${devel.visitcount}</div>
    	</div>
    	<div class="text">${devel.content}</div>
    </div>
    <div class="footer">
    	<div class="next"><a href="devel2.do?num=${devel.num+1}">이전글</a></div>
    	<div class="next"><a href="devel2.do?num=${devel.num-1}">다음글</a></div>
    </div>
</section>
