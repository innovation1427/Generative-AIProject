...
<section id="cat2">
	<div class="header">
		...
		<div class="back"><a href="notice.do?page=${currentPage}">목록</a></div>
	</div>
    <div class="center">
    	<div class="info">
    		<div class="title2">${notice.title}</div>
    		<div class="nick">${notice.nickname}</div>
    		<div class="date">${notice.postdate}</div>
    		<div class="count">${notice.visitcount}</div>
    	</div>
    	<div class="text">${notice.content}</div>
    </div>
    <div class="footer">
    	<div class="next"><a href="notice2.do?num=${notice.num+1}">이전글</a></div>
    	<div class="next"><a href="notice2.do?num=${notice.num-1}">다음글</a></div>
    </div>
</section>
