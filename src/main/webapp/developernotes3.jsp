...
<section id="cat2">
	...
	<form method="get" action="inputdevel.do">
    <div class="center">
    	<div class="info">
    		<input type="text" id="title" name="title" placeholder="제목" required size="95">
    	</div>
    	<div class="text"><textarea id="text" name="text" placeholder="내용" required rows="20" cols="90">
</textarea></div>
    </div>
   <div class="footer">
    	<div class="next"><button type="submit" value="등록">등록</button></div>
    </div>
    </form>
